...
public class Error
{
    public static string String(Result errcode)
    {
        switch (errcode)
        {
            ...
            case Result.ErrFileCouldnotseek:
                return
            ...
            case Result.ErrInitialization: return "FMOD was not initialized correctly to support this function.";
            case Result.ErrInitialized: return "Cannot call this command after System::init.";
            ...
            case Result.ErrOutputNodrivers:
                return
            ...
            case Result.ErrSubsoundAllocated:
                return
            ...
            case Result.ErrSubsoundCantmove:
                return
            ...
            case Result.ErrToomanychannels:
                return
            ...
            case Result.ErrStudioUninitialized: return "The Studio::System object is not yet initialized.";
