...
public delegate Result SystemCallback(IntPtr system, SystemCallbackType type, IntPtr commanddata1, IntPtr commanddata2,
    IntPtr userdata);

public delegate Result ChannelcontrolCallback(IntPtr channelcontrol, ChannelcontrolType controltype,
    ChannelcontrolCallbackType callbacktype, IntPtr commanddata1, IntPtr commanddata2);
...
public struct Createsoundexinfo
{
    ...
    public SoundPcmreadCallback Pcmreadcallback
    {
        ...
        get => pcmreadcallback_internal == IntPtr.Zero
            ? null
            : (SoundPcmreadCallback)Marshal.GetDelegateForFunctionPointer(pcmreadcallback_internal,
                typeof(SoundPcmreadCallback));
    }
    ...
    public SoundPcmsetposCallback Pcmsetposcallback
    {
        ...
        get => pcmsetposcallback_internal == IntPtr.Zero
            ? null
            : (SoundPcmsetposCallback)Marshal.GetDelegateForFunctionPointer(pcmsetposcallback_internal,
                typeof(SoundPcmsetposCallback));
    }
    ...
    public SoundNonblockCallback Nonblockcallback
    {
        ...
        get => nonblockcallback_internal == IntPtr.Zero
            ? null
            : (SoundNonblockCallback)Marshal.GetDelegateForFunctionPointer(nonblockcallback_internal,
                typeof(SoundNonblockCallback));
    }
    ...
    public FileOpenCallback Fileuseropen
    {
        ...
        get => fileuseropen_internal == IntPtr.Zero
            ? null
            : (FileOpenCallback)Marshal.GetDelegateForFunctionPointer(fileuseropen_internal, typeof(FileOpenCallback));
    }
    ...
    public FileCloseCallback Fileuserclose
    {
        ...
        get => fileuserclose_internal == IntPtr.Zero
            ? null
            : (FileCloseCallback)Marshal.GetDelegateForFunctionPointer(fileuserclose_internal,
                typeof(FileCloseCallback));
    }
    ...
    public FileReadCallback Fileuserread
    {
        ...
        get => fileuserread_internal == IntPtr.Zero
            ? null
            : (FileReadCallback)Marshal.GetDelegateForFunctionPointer(fileuserread_internal, typeof(FileReadCallback));
    }
    ...
    public FileSeekCallback Fileuserseek
    {
        ...
        get => fileuserseek_internal == IntPtr.Zero
            ? null
            : (FileSeekCallback)Marshal.GetDelegateForFunctionPointer(fileuserseek_internal, typeof(FileSeekCallback));
    }
    ...
    public FileAsyncreadCallback Fileuserasyncread
    {
        ...
        get => fileuserasyncread_internal == IntPtr.Zero
            ? null
            : (FileAsyncreadCallback)Marshal.GetDelegateForFunctionPointer(fileuserasyncread_internal,
                typeof(FileAsyncreadCallback));
    }

    public FileAsynccancelCallback Fileuserasynccancel
    {
        set => fileuserasynccancel_internal =
            value == null ? IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(value);
        get => fileuserasynccancel_internal == IntPtr.Zero
            ? null
            : (FileAsynccancelCallback)Marshal.GetDelegateForFunctionPointer(fileuserasynccancel_internal,
                typeof(FileAsynccancelCallback));
    }
}
...
public class Preset
{
    public static ReverbProperties Off()
    {
        return new ReverbProperties(1000, 7, 11, 5000, 100, 100, 100, 250, 0, 20, 96, -80.0f);
    }

    public static ReverbProperties Generic()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 83, 100, 100, 250, 0, 14500, 96, -8.0f);
    }

    public static ReverbProperties Paddedcell()
    {
        return new ReverbProperties(170, 1, 2, 5000, 10, 100, 100, 250, 0, 160, 84, -7.8f);
    }

    public static ReverbProperties Room()
    {
        return new ReverbProperties(400, 2, 3, 5000, 83, 100, 100, 250, 0, 6050, 88, -9.4f);
    }

    public static ReverbProperties Bathroom()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 54, 100, 60, 250, 0, 2900, 83, 0.5f);
    }

    public static ReverbProperties Livingroom()
    {
        return new ReverbProperties(500, 3, 4, 5000, 10, 100, 100, 250, 0, 160, 58, -19.0f);
    }

    public static ReverbProperties Stoneroom()
    {
        return new ReverbProperties(2300, 12, 17, 5000, 64, 100, 100, 250, 0, 7800, 71, -8.5f);
    }

    public static ReverbProperties Auditorium()
    {
        return new ReverbProperties(4300, 20, 30, 5000, 59, 100, 100, 250, 0, 5850, 64, -11.7f);
    }

    public static ReverbProperties Concerthall()
    {
        return new ReverbProperties(3900, 20, 29, 5000, 70, 100, 100, 250, 0, 5650, 80, -9.8f);
    }

    public static ReverbProperties Cave()
    {
        return new ReverbProperties(2900, 15, 22, 5000, 100, 100, 100, 250, 0, 20000, 59, -11.3f);
    }

    public static ReverbProperties Arena()
    {
        return new ReverbProperties(7200, 20, 30, 5000, 33, 100, 100, 250, 0, 4500, 80, -9.6f);
    }

    public static ReverbProperties Hangar()
    {
        return new ReverbProperties(10000, 20, 30, 5000, 23, 100, 100, 250, 0, 3400, 72, -7.4f);
    }

    public static ReverbProperties Carpettedhallway()
    {
        return new ReverbProperties(300, 2, 30, 5000, 10, 100, 100, 250, 0, 500, 56, -24.0f);
    }

    public static ReverbProperties Hallway()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 59, 100, 100, 250, 0, 7800, 87, -5.5f);
    }

    public static ReverbProperties Stonecorridor()
    {
        return new ReverbProperties(270, 13, 20, 5000, 79, 100, 100, 250, 0, 9000, 86, -6.0f);
    }

    public static ReverbProperties Alley()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 86, 100, 100, 250, 0, 8300, 80, -9.8f);
    }

    public static ReverbProperties Forest()
    {
        return new ReverbProperties(1500, 162, 88, 5000, 54, 79, 100, 250, 0, 760, 94, -12.3f);
    }

    public static ReverbProperties City()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 67, 50, 100, 250, 0, 4050, 66, -26.0f);
    }

    public static ReverbProperties Mountains()
    {
        return new ReverbProperties(1500, 300, 100, 5000, 21, 27, 100, 250, 0, 1220, 82, -24.0f);
    }

    public static ReverbProperties Quarry()
    {
        return new ReverbProperties(1500, 61, 25, 5000, 83, 100, 100, 250, 0, 3400, 100, -5.0f);
    }

    public static ReverbProperties Plain()
    {
        return new ReverbProperties(1500, 179, 100, 5000, 50, 21, 100, 250, 0, 1670, 65, -28.0f);
    }

    public static ReverbProperties Parkinglot()
    {
        return new ReverbProperties(1700, 8, 12, 5000, 100, 100, 100, 250, 0, 20000, 56, -19.5f);
    }

    public static ReverbProperties Sewerpipe()
    {
        return new ReverbProperties(2800, 14, 21, 5000, 14, 80, 60, 250, 0, 3400, 66, 1.2f);
    }

    public static ReverbProperties Underwater()
    {
        return new ReverbProperties(1500, 7, 11, 5000, 10, 100, 100, 250, 0, 500, 92, 7.0f);
    }
}
...
{
    public static Result Initialize(IntPtr poolmem, int poollen, MemoryAllocCallback useralloc,
        MemoryReallocCallback userrealloc, MemoryFreeCallback userfree, MemoryType memtypeflags = MemoryType.All)
    {
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Memory_Initialize(IntPtr poolmem, int poollen, MemoryAllocCallback useralloc,
...
public struct Debug
{
    public static Result Initialize(DebugFlags flags, DebugMode mode = DebugMode.Tty, DebugCallback callback = null,
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Debug_Initialize(DebugFlags flags, DebugMode mode, DebugCallback callback,
        byte[] filename);
...
{
    public static Result SetAttributes(ThreadType type, ThreadAffinity affinity = ThreadAffinity.GroupDefault,
        ThreadPriority priority = ThreadPriority.Default, ThreadStackSize stacksize = ThreadStackSize.Default)
    {
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Thread_SetAttributes(ThreadType type, ThreadAffinity affinity,
        ThreadPriority priority, ThreadStackSize stacksize);
...
public struct System
{
    ...
    public Result GetDriverInfo(int id, out string name, int namelen, out global::System.Guid guid, out int systemrate,
    ...
    public Result GetDriverInfo(int id, out global::System.Guid guid, out int systemrate, out Speakermode speakermode,
    ...
    public Result SetFileSystem(FileOpenCallback useropen, FileCloseCallback userclose, FileReadCallback userread,
        FileSeekCallback userseek, FileAsyncreadCallback userasyncread, FileAsynccancelCallback userasynccancel,
        int blockalign)
    {
    ...
    public Result AttachFileSystem(FileOpenCallback useropen, FileCloseCallback userclose, FileReadCallback userread,
    ...
    public Result LoadPlugin(string filename, out uint handle, uint priority = 0)
    {
        using (var encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_LoadPlugin(Handle, encoder.ByteFromStringUtf8(filename), out handle, priority);
        }
    }

    public Result UnloadPlugin(uint handle)
    {
        return FMOD5_System_UnloadPlugin(Handle, handle);
    }

    public Result GetNumNestedPlugins(uint handle, out int count)
    {
        return FMOD5_System_GetNumNestedPlugins(Handle, handle, out count);
    }

    public Result GetNestedPlugin(uint handle, int index, out uint nestedhandle)
    {
        return FMOD5_System_GetNestedPlugin(Handle, handle, index, out nestedhandle);
    }
    ...
    {
        return FMOD5_System_GetPluginHandle(Handle, plugintype, index, out handle);
    }
    ...
    public Result GetPluginInfo(uint handle, out Plugintype plugintype, out string name, int namelen, out uint version)
    {
        ...
        var result = FMOD5_System_GetPluginInfo(Handle, handle, out plugintype, stringMem, namelen, out version);
        using (var encoder = StringHelper.GetFreeHelper())
        {
    ...
    {
        return FMOD5_System_GetPluginInfo(Handle, handle, out plugintype, IntPtr.Zero, 0, out version);
    }

    public Result SetOutputByPlugin(uint handle)
    {
        return FMOD5_System_SetOutputByPlugin(Handle, handle);
    }

    public Result GetOutputByPlugin(out uint handle)
    {
        return FMOD5_System_GetOutputByPlugin(Handle, out handle);
    }

    public Result CreateDspByPlugin(uint handle, out Dsp dsp)
    {
        return FMOD5_System_CreateDSPByPlugin(Handle, handle, out dsp.Handle);
    }

    public Result GetDspInfoByPlugin(uint handle, out IntPtr description)
    {
        return FMOD5_System_GetDSPInfoByPlugin(Handle, handle, out description);
    }

    public Result RegisterDsp(ref DspDescription description, out uint handle)
    {
        return FMOD5_System_RegisterDSP(Handle, ref description, out handle);
    }
    ...
    {
        return FMOD5_System_GetOutputHandle(Handle, out handle);
    }
    ...
    {
        return FMOD5_System_CreateSound(Handle, nameOrData, mode, ref exinfo, out sound.Handle);
    }
    ...
    {
        return FMOD5_System_CreateStream(Handle, nameOrData, mode, ref exinfo, out sound.Handle);
    }
    ...
    public Result CreateChannelGroup(string name, out ChannelGroup channelgroup)
    {
        using (var encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_System_CreateChannelGroup(Handle, encoder.ByteFromStringUtf8(name), out channelgroup.Handle);
        }
    }
    ...
    // Routing to ports.
    public Result AttachChannelGroupToPort(PortType portType, ulong portIndex, ChannelGroup channelgroup,
        bool passThru = false)
    {
    ...
    public Result GetRecordDriverInfo(int id, out string name, int namelen, out global::System.Guid guid,
        out int systemrate, out Speakermode speakermode, out int speakermodechannels, out DriverState state)
    {
        var stringMem = Marshal.AllocHGlobal(namelen);
    ...
    public Result GetRecordDriverInfo(int id, out global::System.Guid guid, out int systemrate,
        out Speakermode speakermode, out int speakermodechannels, out DriverState state)
    {
        return FMOD5_System_GetRecordDriverInfo(Handle, id, IntPtr.Zero, 0, out guid, out systemrate, out speakermode,
            out speakermodechannels, out state);
    }
    ...
    private static extern Result FMOD5_System_GetDriverInfo(IntPtr system, int id, IntPtr name, int namelen,
        out global::System.Guid guid, out int systemrate, out Speakermode speakermode, out int speakermodechannels);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_SetSoftwareFormat(IntPtr system, int samplerate, Speakermode speakermode,
        int numrawspeakers);
    ...
    private static extern Result
        FMOD5_System_GetDSPBufferSize(IntPtr system, out uint bufferlength, out int numbuffers);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_SetFileSystem(IntPtr system, FileOpenCallback useropen,
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_AttachFileSystem(IntPtr system, FileOpenCallback useropen,
        FileCloseCallback userclose, FileReadCallback userread, FileSeekCallback userseek);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_SetCallback(IntPtr system, SystemCallback callback,
    ...
    [DllImport(Version.Dll)]
    private static extern Result
        FMOD5_System_LoadPlugin(IntPtr system, byte[] filename, out uint handle, uint priority);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_RegisterDSP(IntPtr system, ref DspDescription description,
        out uint handle);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_CreateSound(IntPtr system, byte[] nameOrData, Mode mode,
        ref Createsoundexinfo exinfo, out IntPtr sound);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_CreateSound(IntPtr system, IntPtr nameOrData, Mode mode,
        ref Createsoundexinfo exinfo, out IntPtr sound);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_CreateStream(IntPtr system, byte[] nameOrData, Mode mode,
        ref Createsoundexinfo exinfo, out IntPtr sound);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_CreateStream(IntPtr system, IntPtr nameOrData, Mode mode,
        ref Createsoundexinfo exinfo, out IntPtr sound);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_PlaySound(IntPtr system, IntPtr sound, IntPtr channelgroup, bool paused,
        out IntPtr channel);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_System_AttachChannelGroupToPort(IntPtr system, PortType portType,
...
public struct Sound
{
    ...
    public Result AddSyncPoint(uint offset, Timeunit offsettype, string name, out IntPtr point)
    {
        using (var encoder = StringHelper.GetFreeHelper())
        {
            return FMOD5_Sound_AddSyncPoint(Handle, offset, offsettype, encoder.ByteFromStringUtf8(name), out point);
        }
    }
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Sound_GetFormat(IntPtr sound, out SoundType type, out SoundFormat format,
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Sound_AddSyncPoint(IntPtr sound, uint offset, Timeunit offsettype, byte[] name,
        out IntPtr point);
...
public struct Channel : IChannelControl
{
    ...
    public Result SetMixLevelsOutput(float frontleft, float frontright, float center, float lfe, float surroundleft,
        float surroundright, float backleft, float backright)
    {
        return FMOD5_Channel_SetMixLevelsOutput(Handle, frontleft, frontright, center, lfe, surroundleft, surroundright,
            backleft, backright);
    }
    ...
    {
        return FMOD5_Channel_SetMixMatrix(Handle, matrix, outchannels, inchannels, inchannelHop);
    }

    public Result GetMixMatrix(float[] matrix, out int outchannels, out int inchannels, int inchannelHop = 0)
    {
        return FMOD5_Channel_GetMixMatrix(Handle, matrix, out outchannels, out inchannels, inchannelHop);
    }
    ...
    {
        return FMOD5_Channel_SetDelay(Handle, dspclockStart, dspclockEnd, stopchannels);
    }

    public Result GetDelay(out ulong dspclockStart, out ulong dspclockEnd)
    {
        return FMOD5_Channel_GetDelay(Handle, out dspclockStart, out dspclockEnd, IntPtr.Zero);
    }

    public Result GetDelay(out ulong dspclockStart, out ulong dspclockEnd, out bool stopchannels)
    {
        return FMOD5_Channel_GetDelay(Handle, out dspclockStart, out dspclockEnd, out stopchannels);
    }
    ...
    {
        return FMOD5_Channel_RemoveFadePoints(Handle, dspclockStart, dspclockEnd);
    }

    public Result GetFadePoints(ref uint numpoints, ulong[] pointDspclock, float[] pointVolume)
    {
        return FMOD5_Channel_GetFadePoints(Handle, ref numpoints, pointDspclock, pointVolume);
    }
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Channel_GetLoopPoints(IntPtr channel, out uint loopstart, Timeunit loopstarttype,
        out uint loopend, Timeunit loopendtype);
    ...
    private static extern Result FMOD5_Channel_GetMixMatrix(IntPtr channel, float[] matrix, out int outchannels,
        out int inchannels, int inchannelHop);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Channel_GetDSPClock(IntPtr channel, out ulong dspclock, out ulong parentclock);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Channel_SetDelay(IntPtr channel, ulong dspclockStart, ulong dspclockEnd,
        bool stopchannels);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Channel_GetDelay(IntPtr channel, out ulong dspclockStart, out ulong dspclockEnd,
        IntPtr zero);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Channel_GetFadePoints(IntPtr channel, ref uint numpoints, ulong[] pointDspclock,
        float[] pointVolume);
    ...
    [DllImport(Version.Dll)]
    private static extern Result
        FMOD5_Channel_Set3DMinMaxDistance(IntPtr channel, float mindistance, float maxdistance);
...
public struct ChannelGroup : IChannelControl
{
    ...
    {
        return FMOD5_ChannelGroup_SetMixMatrix(Handle, matrix, outchannels, inchannels, inchannelHop);
    }

    public Result GetMixMatrix(float[] matrix, out int outchannels, out int inchannels, int inchannelHop)
    {
        return FMOD5_ChannelGroup_GetMixMatrix(Handle, matrix, out outchannels, out inchannels, inchannelHop);
    }
    ...
    {
        return FMOD5_ChannelGroup_SetDelay(Handle, dspclockStart, dspclockEnd, stopchannels);
    }

    public Result GetDelay(out ulong dspclockStart, out ulong dspclockEnd)
    {
        return FMOD5_ChannelGroup_GetDelay(Handle, out dspclockStart, out dspclockEnd, IntPtr.Zero);
    }

    public Result GetDelay(out ulong dspclockStart, out ulong dspclockEnd, out bool stopchannels)
    {
        return FMOD5_ChannelGroup_GetDelay(Handle, out dspclockStart, out dspclockEnd, out stopchannels);
    }
    ...
    public Result RemoveFadePoints(ulong dspclockStart, ulong dspclockEnd)
    {
        return FMOD5_ChannelGroup_RemoveFadePoints(Handle, dspclockStart, dspclockEnd);
    }

    public Result GetFadePoints(ref uint numpoints, ulong[] pointDspclock, float[] pointVolume)
    {
        return FMOD5_ChannelGroup_GetFadePoints(Handle, ref numpoints, pointDspclock, pointVolume);
    }
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_AddGroup(IntPtr channelgroup, IntPtr group, bool propagatedspclock,
        IntPtr zero);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_SetMixMatrix(IntPtr channelgroup, float[] matrix, int outchannels,
        int inchannels, int inchannelHop);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_SetDelay(IntPtr channelgroup, ulong dspclockStart,
        ulong dspclockEnd, bool stopchannels);

    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_GetDelay(IntPtr channelgroup, out ulong dspclockStart,
        out ulong dspclockEnd, IntPtr zero);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_RemoveFadePoints(IntPtr channelgroup, ulong dspclockStart,
        ulong dspclockEnd);
    ...
    [DllImport(Version.Dll)]
    private static extern Result
        FMOD5_ChannelGroup_Set3DAttributes(IntPtr channelgroup, ref Vector pos, ref Vector vel);

    [DllImport(Version.Dll)]
    private static extern Result
        FMOD5_ChannelGroup_Get3DAttributes(IntPtr channelgroup, out Vector pos, out Vector vel);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_ChannelGroup_Get3DConeSettings(IntPtr channelgroup, out float insideconeangle,
        out float outsideconeangle, out float outsidevolume);
...
public struct SoundGroup
{
    ...
    private static extern Result FMOD5_SoundGroup_GetMaxAudibleBehavior(IntPtr soundgroup,
        out SoundgroupBehavior behavior);
...
public struct Dsp
{
    ...
    {
        return FMOD5_DSP_AddInput(Handle, input.Handle, IntPtr.Zero, DspconnectionType.Standard);
    }
    ...
    {
        return FMOD5_DSP_SetChannelFormat(Handle, channelmask, numchannels, sourceSpeakermode);
    }

    public Result GetChannelFormat(out Channelmask channelmask, out int numchannels, out Speakermode sourceSpeakermode)
    {
        return FMOD5_DSP_GetChannelFormat(Handle, out channelmask, out numchannels, out sourceSpeakermode);
    }
    ...
    {
        return FMOD5_DSP_GetOutputChannelFormat(Handle, inmask, inchannels, inspeakermode, out outmask, out outchannels,
            out outspeakermode);
    }
        ...
        out int configheight)
    {
        ...
        var result = FMOD5_DSP_GetInfo(Handle, nameMem, out version, out channels, out configwidth, out configheight);
        using (var encoder = StringHelper.GetFreeHelper())
        {
    ...
    [DllImport(Version.Dll)]
    private static extern Result
        FMOD5_DSP_GetInput(IntPtr dsp, int index, out IntPtr input, out IntPtr inputconnection);
    ...
    private static extern Result FMOD5_DSP_GetChannelFormat(IntPtr dsp, out Channelmask channelmask,
        out int numchannels, out Speakermode sourceSpeakermode);
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_DSP_GetParameterFloat(IntPtr dsp, int index, out float value, IntPtr valuestr,
        int valuestrlen);
    ...
    [DllImport(Version.Dll)]
    public static extern Result FMOD5_DSP_GetMeteringInfo(IntPtr dsp, out DspMeteringInfo inputInfo,
...
public struct DspConnection
{
    ...
    public Result SetMixMatrix(float[] matrix, int outchannels, int inchannels, int inchannelHop = 0)
    {
        return FMOD5_DSPConnection_SetMixMatrix(Handle, matrix, outchannels, inchannels, inchannelHop);
    }

    public Result GetMixMatrix(float[] matrix, out int outchannels, out int inchannels, int inchannelHop = 0)
    {
        return FMOD5_DSPConnection_GetMixMatrix(Handle, matrix, out outchannels, out inchannels, inchannelHop);
    }
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_DSPConnection_SetMixMatrix(IntPtr dspconnection, float[] matrix, int outchannels,
        int inchannels, int inchannelHop);
...
public struct Geometry
{
    ...
    {
        return FMOD5_Geometry_AddPolygon(Handle, directocclusion, reverbocclusion, doublesided, numvertices, vertices,
            out polygonindex);
    }
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Geometry_SetPolygonAttributes(IntPtr geometry, int index, float directocclusion,
...
public struct Reverb3D
{
    ...
    [DllImport(Version.Dll)]
    private static extern Result FMOD5_Reverb3D_Set3DAttributes(IntPtr reverb3d, ref Vector position, float mindistance,
        float maxdistance);
...
internal static class StringHelper
{
    ...
    {
        private UTF8Encoding _encoding = new();
        ...
        public byte[] ByteFromStringUtf8(string s)
        {
            ...
            var maximumLength = _encoding.GetMaxByteCount(s.Length) + 1; // +1 for null terminator
            if (maximumLength > _encodedBuffer.Length)
            {
                var encodedLength = _encoding.GetByteCount(s) + 1; // +1 for null terminator
                if (encodedLength > _encodedBuffer.Length) _encodedBuffer = new byte[RoundUpPowerTwo(encodedLength)];
            }

            var byteCount = _encoding.GetBytes(s, 0, s.Length, _encodedBuffer, 0);
        ...
        public string StringFromNative(IntPtr nativePtr)
        {
            ...
            if (nativeLen > _encodedBuffer.Length) _encodedBuffer = new byte[RoundUpPowerTwo(nativeLen)];

            Marshal.Copy(nativePtr, _encodedBuffer, 0, nativeLen);

            var maximumLength = _encoding.GetMaxCharCount(nativeLen);
            if (maximumLength > _decodedBuffer.Length)
            {
                var decodedLength = _encoding.GetCharCount(_encodedBuffer, 0, nativeLen);
                if (decodedLength > _decodedBuffer.Length) _decodedBuffer = new char[RoundUpPowerTwo(decodedLength)];
            }

            var charCount = _encoding.GetChars(_encodedBuffer, 0, nativeLen, _decodedBuffer, 0);
    ...
    private static List<ThreadSafeEncoding> _encoders = new(1);
    ...
    public static ThreadSafeEncoding GetFreeHelper()
    {
        lock (_encoders)
        {
            ...
            for (var i = 0; i < _encoders.Count; i++)
